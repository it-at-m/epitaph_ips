...
class ColorConstants {
  ...
  static Color buttonGreen = Color.fromRGBO(141, 168, 8, 0.45);
  static Color black = Colors.black;
  static Color kvrBlue = Color(0xff172634);
  static Color kvrBlue10 = Color(0xffdfe2ed);
  static Color kvrBlue30 = Color(0xffA5ABC6);
  static Color kvrBlue50 = Color(0xff8893b3);
  static Color kvrBlue70 = Color(0xff405685);
  static Color kvrBlue100 = Color(0xff00245c);
  static Color white = Color(0xffdfe1ed);
  static Color backgroundColor = Color(0xFFB7BED3);
  ...
  static Color boxShadowBlue = Color.fromRGBO(
  ...
  static Color myPositionCircle = Color(0x808080).withOpacity(0.3);
